# -*- coding: utf-8 -*-
"""Generate segment and stage employment plots (2000â€“2030) for Q1 2025 dashboard."""
...
SEGMENT_TIMESERIES_PATH = (
    REPO_ROOT / "data/processed/sam_auto_dashboard_2025_Q1/sam_employment_segment_timeseries.csv"
)
STAGE_TIMESERIES_PATH = (
    REPO_ROOT / "data/processed/sam_auto_dashboard_2025_Q1/sam_employment_stage_timeseries.csv"
)
OUTPUT_DIR = (
    REPO_ROOT
    / "data"
    / "processed"
    / "sam_auto_dashboard_2025_Q1"
    / "plots_q1"
)
