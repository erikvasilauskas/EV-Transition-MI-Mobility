...
def build_change_frame(df: pd.DataFrame, raw_lookup: dict[str, float]) -> pd.DataFrame:
    ...
    result["employment_auto_2024"] = base["employment_auto"].astype(float)
    result["employment_auto_2030"] = target["employment_auto"].astype(float)
    result["change_level"] = (
        result["employment_auto_2030"] - result["employment_auto_2024"]
    )
    result["change_percent"] = np.where(
        result["employment_auto_2024"] > 0,
        result["change_level"] / result["employment_auto_2024"],
        np.nan,
    )
