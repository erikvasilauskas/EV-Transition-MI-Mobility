...
| MCDA staffing patterns (10 segments) | Michigan Center for Data and Analytics | data/raw/mcda-staffing-data-update-11-5-25.xlsx | Provided updates | Internal | Source for Michigan segment rollups processed via scripts/process_mcda_staffing.py (supersedes the earlier "Staffing Patterns for 10 Categories" workbook). |
